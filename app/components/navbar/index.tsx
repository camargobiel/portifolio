...
export function Navbar() {
  ...
  return (
    <nav className="w-100 p-4 pl-20 h-24 flex items-center justify-evenly fixed bg-white w-full z-50">
      <section
      ...
      <section className="flex gap-20">
        ...
        <button className="text-primary text-xl border-b-[1px] border-transparent hover:border-b-[1px] hover:border-primary transition-all">
          Sobre mim
        </button>
        <button className="text-primary text-xl border-b-[1px] border-transparent hover:border-b-[1px] hover:border-primary transition-all">
          Meus projetos
